...
// Hàm tạo nội dung HTML cho mỗi game với emulator nhúng
function generateGamePageWithEmulator(game) {
    ...
    <style>
        * {
        ...
        @media (max-width: 768px) {
            ...
            .game-header, .game-content, .play-section {
                padding: 20px;
            }
...
<body>
    <div class="container">
        ...
        <section class="play-section">
            <h2 style="border: none; margin-bottom: 10px;">🎮 Chơi ngay ${game.name}</h2>
            <p style="color: #888; margin-bottom: 15px;">Click nút bên dưới để bắt đầu chơi game</p>
            <button class="play-button" onclick="startGame()">▶️ Bắt đầu chơi</button>
            <iframe id="game-frame" class="game-frame" src="../../run.html?app=${game.id}"></iframe>
        </section>
        ...
        <main class="game-content">
            ...
            <section class="gameplay">
                ...
                <p>${game.gameplay}</p>
                <p style="margin-top: 10px;">Game phù hợp với mọi lứa tuổi và có thể chơi trực tiếp trên trình duyệt mà không cần cài đặt gì thêm.</p>
            </section>
        ...
        <a href="../../index.html" class="back-link" style="margin-top: 20px;">← Xem tất cả game</a>
    </div>
...
console.log('🔄 Regenerating game pages with embedded emulator...\n');

gamesData.forEach(game => {
    const { slug, html } = generateGamePageWithEmulator(game);
...
console.log(`\n🎉 Successfully updated ${successCount}/${gamesData.length} game pages!`);
console.log('\n✨ New features:');
console.log('  - Embedded game emulator in each page');
console.log('  - Click "Bắt đầu chơi" to play without leaving the page');
console.log('  - Better SEO with game content + playable feature');
